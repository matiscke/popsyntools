...
PACKAGENAME = metadata.get('package_name', 'popsyntools')
DESCRIPTION = metadata.get('description', 'A set of analysis tools for planet population synthesis')
AUTHOR = metadata.get('author', 'Martin Schlecker')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: popsyntools requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
